...
\item La ecuaci\'on matricial anterior, cuando se la escribe como un sistema de ecuaciones, es conocido como las \textbf{Ecuaciones de Balance} de la cadena: 
\[
\forall \, \text{estado } i \colon \, \vec{\pi^*}(i) \; = \; 
\sum_{\text{estados }x} \vec{\pi^*}(x) \, \vec{P}(x,i) 
\]
